			...
			<div class="col-xs-12">
			  ...
			  <?php if($ROW['member_id']==true){ ?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					<input id="form-field-1" placeholder="Currenct Sponsor" name="member_user_id" onchange="check_member(this.value);"  class="col-xs-10 col-sm-5 validate[required]" type="text" value="<?php echo $ROW['spsr_user_id']; ?>" readonly="true">
				  </div>
				</div>
					<div class="form-group">
				  <label class="col-sm-3 control-label no-padding-right" for="form-field-1">  Current Sponsor Name :  </label>
				  <div class="col-sm-9">
				
				                 <input id="name" placeholder="Member Name" name="member_user_id" style="width: 429px;" readonly  class="col-xs-10 col-sm-5  " type="text" value="<?php echo $ROW['spsr_full_name']; ?>">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-9">
					<input id="form-field-1" placeholder="New Sponsor Id" name="new_sponsor_id"  class="col-xs-10 col-sm-5 validate[required]" type="text" value="" maxlength="10">
				  </div>
				</div>
			   ...
			   <div class="space-4"></div>           
				<div class="clearfix form-action">
				  <div class="col-md-offset-3 col-md-9">
					...
					<button type="submit" name="submitSponsorMember" value="1" class="btn btn-success"> <i class="ace-icon fa fa-check bigger-110"></i> Update</button>
