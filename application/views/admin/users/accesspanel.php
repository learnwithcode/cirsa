    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Member <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Access Panel </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php  get_message(); ?>
          <div class="col-xs-12" style="min-height:500px;">
            ...
            <form class="form-horizontal"  target="_blank" name="form-page" id="form-page" action="<?php echo ADMIN_PATH."member/accesspanel"; ?>" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input id="form-field-1" placeholder="Member ID" name="member_user_id"  class="col-xs-10 col-sm-5 validate[required]" type="text" value="<?php echo $user_id; ?>">
                </div>
              </div>
