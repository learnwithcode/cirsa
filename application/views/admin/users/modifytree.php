    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Modify <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Tree </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php  get_message(); ?>
          <div class="col-xs-12">
            ...
            <form class="form-horizontal"   name="form-page" id="form-page" action="<?php echo generateAdminForm("member","modifytree",""); ?>" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input id="form-field-1" placeholder="Currenct Sponsor" name="member_user_id"  class="col-xs-10 col-sm-5 validate[required]" type="text" value="<?php echo $model->getMemberUserId($ROW['sponsor_id']); ?>" readonly="true">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Current Spill : </label>
                <div class="col-sm-9">
                  <input id="form-field-1" placeholder="Currenct Spill" name="member_spill_id"  class="col-xs-10 col-sm-5 validate[required]" type="text" value="<?php echo $model->getMemberUserId($ROW['spil_id']); ?>" readonly="true">
                </div>
              </div>
              
              <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> New Spill Id : </label>
                <div class="col-sm-9">
                  <input id="new_spill_id" placeholder="New Spill Id" name="new_spill_id"  class="col-xs-10 col-sm-5 validate[required]" type="text" value="" maxlength="10">
                </div>
              </div>
              ...
              <div class="clearfix form-action">
                <div class="col-md-offset-3 col-md-9">
                  ...
                  <button type="submit" name="submitSpillMember" value="1" class="btn btn-success"> <i class="ace-icon fa fa-check bigger-110"></i> Update Tree </button>
