...
$QR_PAGES = "SELECT ts.*, tp.pin_name , tp.daily_return, tp.no_day, tp.daily_return*tp.no_day AS total_return,
                ...
                WHERE ts.type='A' and ts.retopup='N' and ts.pool='N' $StrWhr
            ...
            <div class="container-fluid">
                ...
                <div class="pull-right tableTools-container">
                  <div class="dt-buttons btn-overlap btn-group"> 
                    ...
                    <a  href="#"  aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-csv buttons-html5 btn btn-white btn-primary btn-bold"><span><i class="fa fa-database bigger-110 orange"></i> <span class="hidden">Export to CSV</span></span></a> 
                   ...
                   <tr><td colspan="8" class="center" style="background-color: #797979; padding: 0px 0px 4px 0px;"> </td>
                      ...
                      <tr>
                        ...
                        <td width="200"><a href="javascript:void(0)"><?php echo $AR_DT['subcription_id']; ?>[<?php echo $AR_DT['user_id']; ?>]</a></td>
                       
                        <td width="200">Date Of Activation : </td>
                        <td width="300"><?php echo date("F j, Y h:m:s A" ,strtotime($AR_DT['date_time'])); ?></td>
                         <td > </td>
                          <td > </td>
                        <td style="display:none;">Plan : </td>
                        <td style="display:none;"><?php echo $AR_DT['pin_name']; ?>(<?php echo number_format($AR_DT['total_amt']); ?>)</td>
