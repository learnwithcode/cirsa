...
<div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title"> Member <small> <i class="ace-icon fa fa-angle-double-right"></i>&nbsp; Tree</small>  </h4>
                        </div>
...
<div class="row visible-lg">
        <div class="col-md-1"><img src="<?php echo BASE_PATH; ?>assets/images/black1.png" alt="Empty" width="50%"><br>Empty</div>
<div class="col-md-1"><img src="<?php echo BASE_PATH; ?>assets/images/yellow1.png" alt="Registration" width="50%"><br>Registration</div>
<!--<div class="col-md-1"><img src="<?php echo BASE_PATH; ?>assets/images/red1.png" alt="Block" width="50%"><br>Block</div>-->
<div class="col-md-1"><img src="<?php echo BASE_PATH; ?>assets/images/green1.png" alt="Active" width="50%"><br>Active</div> 
        ...
        <tr>
                <td colspan="17" align="center"><?php $model->getNameStatusAdmin($Var1, $Var1, "");?>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="8" align="center"><?php $model->getNameStatusAdmin($Var2, $Var1, "L");?>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td width="1" rowspan="5" align="center"  style="background-image:url(<?php echo BASE_PATH; ?>assets/images/arrow.gif)">&nbsp;</td>
                <td colspan="8" align="center"><?php $model->getNameStatusAdmin($Var3, $Var1, "R");?></td>
              </tr>
              <tr>
              ...
              <tr>
                <td  colspan="4" align="center"><?php $model->getNameStatusAdmin($Var4, $Var2, "L"); ?></td>
                <td colspan="4" align="center"><?php $model->getNameStatusAdmin($Var5, $Var2, "R"); ?></td>
                <td colspan="4" align="center"><?php $model->getNameStatusAdmin($Var6, $Var3, "L");?></td>
                <td colspan="4" align="center"><?php $model->getNameStatusAdmin($Var7, $Var3, "R");?></td>
              </tr>
              <tr>
              ...
              <tr>
                <td  height="" colspan="2" align="center" valign="top"><?php $model->getNameStatusAdmin($Var8, $Var4, "L");?></td>
                <td colspan="2" align="center" valign="top"><?php $model->getNameStatusAdmin($Var9, $Var4, "R");?></td>
                <td colspan="2" align="center" valign="top"><?php $model->getNameStatusAdmin($Var10, $Var5, "L");?></td>
                <td  colspan="2" align="center" valign="top"><?php $model->getNameStatusAdmin($Var11, $Var5, "R");?></td>
                <td  colspan="2" align="center" valign="top"><?php $model->getNameStatusAdmin($Var12, $Var6, "L");?></td>
                <td  colspan="2" align="center" valign="top"><?php $model->getNameStatusAdmin($Var13, $Var6, "R");?></td>
                <td  colspan="2" align="center" valign="top"><?php $model->getNameStatusAdmin($Var14, $Var7, "L");?></td>
                <td  colspan="2" align="center" valign="top"><?php $model->getNameStatusAdmin($Var15, $Var7, "R");?></td>
              </tr>
        <tr>
...
<form name="frmtree" method=get action="?">
  ...
  <input type=hidden name="others" value="<?php echo base64_encode("others".$_GET['member_id']);?>">
</form>
