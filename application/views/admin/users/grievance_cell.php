...
$QR_PAGES="SELECT * FROM tbl_grievance where 1 ";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Member Support <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Grievance Cell </small> </h1>
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="" class="table">
			       ...
			       <td><strong>Name : </strong> <?php echo $AR_DT['name'];?><br><strong>Email : </strong> <?php echo $AR_DT['email'];?><br><strong>Contact No. : </strong> <?php echo $AR_DT['mobile'];?><br><strong>Company : </strong> <?php echo $AR_DT['company'];?><br></td>
			       <td><?php echo $AR_DT['subject'];?></td>
			       <td><?php echo $AR_DT['message'];?></td>
			       
			       <td><?php echo  date('d-F-Y', strtotime($AR_DT['date_time'])); ?></td>
			        </tr>
			        <div class="clearfix"></div>
