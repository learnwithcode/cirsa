    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> LuckyDraw <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Select Lucky Draw </small> </h1>
          
          
          
           <div class="pull-right tableTools-container">
                      <div class="dt-buttons btn-overlap btn-group"> 
                                  <a href="javascript:void(0);" class="dt-button buttons-print btn btn-white btn-primary btn-bold" onClick="return validcheckstatus('arr_ids[]','Lucky Draw','Id');">Lucky Draw <i class="fa fa-trophy" aria-hidden="true"></i></a>
        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            <div class="row">
			 ...
			 <!--<div class="checkbox">-->
													<label>
														<input name="arr_ids[]" value="<?php echo $AR_DT['member_id'];?>" type="checkbox" class="ace">
														<span class="lbl"></span>
													</label>
												<!--</div>-->
