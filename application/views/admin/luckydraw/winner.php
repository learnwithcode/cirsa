...
$QR_PAGES="SELECT tm.member_id,tm.user_id,tm.first_name,tm.member_mobile,tm.member_email FROM `tbl_subscription` as sub LEFT JOIN tbl_members as tm on sub.member_id=tm.member_id WHERE sub.member_id  IN(SELECT member_id from tbl_lucky_drow)";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> LuckyDraw <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;  Lucky Draw Winner </small> </h1>
