...
$QR_PAGES="SELECT type.*,COUNT(pin.type_id) as total FROM `tbl_package_type` as type LEFT JOIN tbl_pintype as pin on type.package_pv = pin.pin_price where 1 group BY pin.pin_price";
              ...
              <div class="col-xs-12">
               <div class="clearfix">
                  <div class="pull-right tableTools-container">
					...
					<a href="<?php echo generateSeoUrlAdmin("package","packageadd",""); ?>" title="" data-original-title="" aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-collection buttons-colvis btn btn-white btn-primary btn-bold"><span><i class="fa fa-plus bigger-110 blue"></i> <span class="">New  Package Type</span></span></a> 
										<a href="<?php echo generateSeoUrlAdmin("package","productlist",""); ?>" title="" data-original-title="" aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-collection buttons-colvis btn btn-white btn-primary btn-bold"><span><i class="fa fa-tasks bigger-110 blue"></i> <span class="">Manage Product</span></span></a> 
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr>
                        ...
                        <td><?php echo $AR_DT['package_name']; ?>   </td>
                        <td><?php echo $AR_DT['package_pv']; ?> [ PV ]</td>
					
						<td>&nbsp;&#8377; <?php echo $AR_DT['turbo_sale'];  ?> /-</td>
                        	<td>&nbsp;&#8377; <?php echo $AR_DT['turbo_bonus'];  ?> /-</td>
						<td><?php echo $AR_DT['total']; ?></td>
                        ...
                        <td><div class="btn-group">
                            ...
                            <a class="btn btn-primary btn-white dropdown-toggle" href="<?php echo generateSeoUrlAdmin("package","packagelist",array("type"=>_e($AR_DT['package_pv']))); ?>">View  <i class="fa fa-eye" aria-hidden="true"></i></a>
							<a class="btn btn-primary btn-white dropdown-toggle" href="<?php echo generateSeoUrlAdmin("package","packageadd",array("package_id"=>_e($AR_DT['package_id']),"action_request"=>"EDIT")); ?>">Edit  <i class="fa fa-pencil" aria-hidden="true"></i></a>
                          </div></td>
                      </tr>
