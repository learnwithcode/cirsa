...
<div class="main-container ace-save-state" id="main-container">
              ...
              <div class="col-xs-12">
               <div class="clearfix">
                  <div class="pull-right tableTools-container">
					...
					<a href="<?php echo generateSeoUrlAdmin("package","addproduct",""); ?>" title="" data-original-title="" aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-collection buttons-colvis btn btn-white btn-primary btn-bold"><span><i class="fa fa-plus bigger-110 blue"></i> <span class="">Add New Product</span></span></a> 
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        <th class="center"> <label class="pos-rel"> Sn. <span class="lbl"></span> </label>                        </th>
                        <th>Product Name</th>
						<th>HSN Code </th>
						<th>Unit</th>
						<th>TAX </th>
  ...
  <td class="center"><label class="pos-rel"> <?php echo $Ctrl; ?> <span class="lbl"></span> </label></td>
    ...
    <td><div class="btn-group">
        <a class="btn btn-primary btn-white dropdown-toggle" href="<?php echo generateSeoUrlAdmin("package","addproduct",array("product_id"=>_e($AR_DT['product_id']),"action_request"=>"EDIT")); ?>">Edit  <i class="fa fa-pencil" aria-hidden="true"></i></a>
                          </div></td>
