...
$Page = $_GET[page]; if($Page == "" or $Page <=0){$Page=1;}
  $QR_PAGES= "SELECT R.*,M.first_name as name , M.user_id as uid , O.operator_name as oname FROM `tbl_recharge` as R LEFT JOIN tbl_recharge_optr as O on R.`opr_id` = O.operator_id LEFT JOIN tbl_members as M on M.member_id = R.member_id WHERE  R.recharge_id > 0 AND R.status='SUCCESS'  order by  R.recharge_id desc";
    ...
    <div class="main-content-inner"> 
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Transaction  <small> <i class="ace-icon fa fa-angle-double-right"></i> Recharge Success   </small> </h1>
