				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
							 <img src="<?php echo BASE_PATH;?>upload/system/<?php echo $model->getValue("CONFIG_LOGO"); ?>" style="width: 100%;" >
							</div>
							...
							<div class="position-relative">
								...
								<div class="widget-body">
										<div class="widget-main">
											...
											Set up Transactonal Credentials...
											</h5>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Login Id" name="loginId" required />
													...
													<label class="block clearfix">
													<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Answer" required name ="answer" />
