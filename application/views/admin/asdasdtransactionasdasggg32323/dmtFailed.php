...
if($_GET['from_date']!='' && $_GET['to_date']!=''){
  ...
  $QR_PAGES= "SELECT R.*,M.first_name as name , M.user_id as uid   FROM `tbl_money_transfer` as R LEFT JOIN tbl_members as M on M.member_id = R.member_id WHERE  R.sender_id > 0  and R.status ='Failure'  and R.isDisplay = 'Y'   $StrWhr  order by  R.sender_id desc";
    ...
    <div class="main-content-inner"> 
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Transaction  <small> <i class="ace-icon fa fa-angle-double-right"></i> DMT Failed Transaction   </small> </h1>
 ...
 <?php $Ctrl++; 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("transaction","dmtFailed","");  ?>" autocomplete="off" method="get">
