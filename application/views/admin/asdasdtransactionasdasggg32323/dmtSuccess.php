...
if($_GET['from_date']!='' && $_GET['to_date']!=''){
  ...
  $QR_PAGES= "SELECT R.*,M.first_name as name , M.user_id as uid   FROM `tbl_money_transfer` as R LEFT JOIN tbl_members as M on M.member_id = R.member_id WHERE  R.sender_id > 0  and R.status ='Success' and R.isDisplay = 'Y'   $StrWhr  order by  R.sender_id desc";
    ...
    <div class="main-content-inner"> 
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Transaction  <small> <i class="ace-icon fa fa-angle-double-right"></i> DMT Success Transaction   </small> </h1>
    ...
    <tbody>
        ...
        <td><?php echo  ($member['sid']);?>  </td>
            ...
            <td><?php echo  ($member['adhar']);?>  </td>
              ...
              <tr  class="trcol" >
            <td><strong>Trns Response</strong></td>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("transaction","dmtSuccess","");  ?>" autocomplete="off" method="get">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input id="form-field-16" placeholder="Order Id" name="order_id"  class="col-xs-10 col-sm-12 " type="text" value="<?php echo $_GET['order_id']; ?>">
              </div>
            </div>
