                                           ...
                                           <div class="col-lg-6" >
                                                <div class="mb-3">
                                                    <label for="property-name" class="form-label">Property
                                                        Name</label>
                                                    <input type="text" id="property-name"  name="propertyname" class="form-control"
                                                        placeholder="Name">
                                                </div>
                                            ...
                                            <div class="col-lg-6" >
                                                ...
                                                <select class="form-control" id="property-categories"  name="propertycat"
                                                    ...
                                                    data-placeholder="Select Categories" required onchange="showPlotDiv()" >
                                             ...
                                             <div class="col-lg-6 Flat_Show" >
                                                      ...
                                                      <label for="beds" class="form-label">Bed Room</label>
                                             ...
                                             <div class="col-lg-6 Flat_Show" >
                                                      ...
                                                      <div class="input-group mb-3">
                                                           ...
                                                           <input type="number" id="flore"  name="flore" 
                                                                class="form-control" placeholder="0">
                                                      </div>
                                            ...
                                            <!--               <input type="number" id="property-zipcode"  name="propertyzipcode" -->
                                            ...
                                            <!--          <select class="form-control" id="choices-city"  name="propertycity"  data-choices-->
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select class="form-control" id="property-for"  name="propertypricetype" data-choices
                                                    ...
                                                    <option value="Thoushand">Thoushand</option>
                                              ...
                                              <div class="col-lg-12" >
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="property-near-by"  name="propertynearby"
                                                        rows="3" placeholder="Enter Near By"></textarea>
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-lg-12" >
                                               ...
                                               <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" id="property_count"  name="property_count"
                                               ...
                                               <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="link-upload"  name="propertyuploadLinkMap"
                                                        class="form-control" placeholder="Link Upload">
                                                </div>
                                            </div>
        ...
        <script>
          ...
          <script>
                function showPlotDiv() {
                    const categorySelect = document.getElementById('property-categories');
                    const plotDiv = document.getElementById('Plot_Show');
                    const flatDiv = document.getElementById('Flat_Show');
                    
                    // Check if the selected value is "Plots"
                    if (categorySelect.value === 'Plots') {
                          $('.Plot_Show').show();
                            $('.Flat_Show').hide();
                    }else{
                          $('.Plot_Show').hide();
