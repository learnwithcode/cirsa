...
$QR_PAGES="SELECT ta.* ,   tm.first_name, tm.last_name, tm.user_id FROM ".prefix."tbl_advert AS ta LEFT JOIN tbl_members AS tm ON tm.member_id=ta.member_id
 WHERE ta.isDelete>0  AND ta.isActive>0 $StrWhr ORDER BY ta.advert_id ASC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Advrt Management <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Active Advt </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['advert_id']; ?> <span class="lbl"></span> </label>
                        </td>
