...
$QR_PAGES="SELECT ta.* FROM ".prefix."tbl_advert AS ta	 WHERE ta.isDelete>0  AND ta.isActive<=0 $StrWhr ORDER BY ta.advert_id ASC";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Advrt Management <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; In-Active Advt  </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
                  ...
                  <tbody>
			       ...
			       ?>
                    <tr>
                      ...
                      <td><?php echo getDateFormat($AR_DT['start_date'],"d M Y h:i"); ?></td>
                      <td><?php echo getDateFormat($AR_DT['expiry_date'],"d M Y h:i"); ?></td>
