...
if($_REQUEST['advert_title']!=''){
	$advert_title = FCrtRplc($_REQUEST['advert_title']);
	$StrWhr .=" AND ( ta.advert_title LIKE '%$advert_title%')";
	$SrchQ .="&advert_title=$advert_title";
}
if($_REQUEST['from_date']!='' && $_REQUEST['to_date']!=''){
	$from_date = InsertDate($_REQUEST['from_date']);
	$to_date = InsertDate($_REQUEST['to_date']);
	$StrWhr .=" AND ta.start_date BETWEEN '$from_date' AND '$to_date'";
	$SrchQ .="&from_date=$from_date&to_date=$to_date";
}


$QR_PAGES="SELECT ta.* , tm.first_name, tm.last_name, tm.user_id FROM ".prefix."tbl_advert AS ta LEFT JOIN tbl_members AS tm ON tm.member_id=ta.member_id	 WHERE ta.isDelete>0  AND ta.oprt_id>0 $StrWhr ORDER BY ta.advert_id ASC";
...
<script type="text/javascript">
	$(function(){
		...
		$(".advertView").on('click',function(){
			var advert_id = $(this).attr('advert_id');
			$('#advert-view').modal('show');
			var URL_LOAD = "<?php echo ADMIN_PATH; ?>json/jsonhandler?switch_type=ADVRT_CONTENT&advert_id="+advert_id;
			$.post(URL_LOAD,function(jsonPost){
				$("#load_content").html(jsonPost);
			});
			return false;
		});
	});
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Advrt Management <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; View Advt  </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <th width="197">Advert Title</th>
                      <th width="163">Advert Link</th>
                      <th width="133">Total Click </th>
                      <th width="111">Clicked</th>
                      <th width="109">Click Left </th>
                      <th width="109">Advert Status</th>
                  ...
                  <tbody>
                    <?php 
			 	 	if($PageVal['TotalRecords'] > 0){
						...
						$total_click = $AR_DT['advert_click'];
						$user_cliked = 0;
						$left_clicked = $total_click-$user_cliked;
			       ?>
                    <tr>
                      <td class="center"><label class="pos-rel"> <?php echo $AR_DT['advert_id']; ?> <span class="lbl"></span> </label>                      </td>
                      <td><?php echo $AR_DT['advert_title']; ?> </td>
                      <td><a target="_blank" href="<?php echo $AR_DT['advert_link']; ?>"><?php echo $AR_DT['advert_link']; ?></a></td>
                      <td><?php echo $total_click; ?></td>
                      <td><?php echo $user_cliked; ?></td>
                      <td><?php echo $left_clicked; ?></td>
                      <td><?php echo ($AR_DT['isActive']>0)? "Active":"In-Active"; ?></td>
                      ...
                      <td><div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-default">
						  	<li> <a href="<?php echo generateSeoUrlAdmin("advert","addadvrt",array("advert_id"=>$AR_DT['advert_id'],"action_request"=>"EDIT")); ?>">Edit</a> </li>
						  	<li> <a href="javascript:void(0)" class="advertView" advert_id="<?php echo $AR_DT['advert_id']; ?>">View</a> </li>
							<li> <a href="<?php echo generateSeoUrlAdmin("advert","addadvrt",array("advert_id"=>$AR_DT['advert_id'],"action_request"=>"DELETE")); ?>">Delete</a> </li>
                          </ul>
                        </div></td>
                    </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" id="load_content">
