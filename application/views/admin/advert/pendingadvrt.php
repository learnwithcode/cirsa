...
$QR_PAGES="SELECT ta.*, tm.first_name, tm.last_name, tm.user_id FROM ".prefix."tbl_advert AS ta LEFT JOIN tbl_members AS tm ON tm.member_id=ta.member_id	 WHERE 
			ta.isDelete>0 AND ta.advert_sts IN('C','R','P') AND ta.member_id>0 $StrWhr ORDER BY ta.advert_id ASC";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Advrt Management <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Pending Advt  </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <th width="133">Post Date </th>
                      <th width="111">Number of Click </th>
                      <th width="109">User Advert Status</th>
                      <th width="113">User Id </th>
                  ...
                  <tbody>
			       ...
			       ?>
                    <tr>
                      ...
                      <td><a href="javascript:void(0)"><?php echo $AR_DT['advert_title']; ?></a> </td>
                      <td><a href="<?php echo $AR_DT['advert_link']; ?>"><?php echo $AR_DT['advert_link']; ?></a></td>
                      <td><?php echo getDateFormat($AR_DT['date_time'],"d M Y h:i"); ?></td>
                      <td><?php echo number_format(0); ?></td>
                      <td><?php echo DisplayText("ADVERT_".$AR_DT['advert_sts']); ?></td>
                      ...
                      <td><div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-default">
						  	...
						  	<li> <a href="<?php echo generateSeoUrlAdmin("advert","addadvrt",array("advert_id"=>$AR_DT['advert_id'])); ?>">View</a> </li>
