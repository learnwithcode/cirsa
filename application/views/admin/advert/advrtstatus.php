...
$QR_PAGES="SELECT ta.* FROM ".prefix."tbl_advert AS ta	 WHERE ta.isDelete>0  AND ta.oprt_id>0 $StrWhr ORDER BY ta.advert_id ASC";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Advrt Management <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Add Status  </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
                  ...
                  <tbody>
			       ...
			       ?>
                    <tr>
                      ...
                      <td><?php echo $model->advertClickCount($AR_DT['advert_id']); ?></td>
