<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	$QR_PAGES="SELECT tcd.*,count(tcd.single_id) as total,sum(tcd.net_income) as net, tm.user_id 
			   FROM ".prefix."tbl_cmsn_singleline AS tcd 
			   LEFT JOIN tbl_members AS tm ON tcd.member_id=tm.member_id
			 
			   WHERE 1 $StrWhr group by tcd.process_id ORDER BY tcd.single_id DESC";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Bonus <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Single Line Income </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
					 <td data-title="Sn No"><?php echo $Ctrl;$Ctrl++;?></td>
                      ...
                      <td data-title="Net Total"><a href="<?php echo generateSeoUrlAdmin("bonus","singleline",""); ?>?process_id=<?php echo $AR_DT['process_id']; ?>">View</a><?php //echo number_format($AR_DT['total_income'],2); ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr class="odd" role="row">
