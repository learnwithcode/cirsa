<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	$QR_PAGES= "SELECT tcd.*, tmf.user_name AS from_user_name, tmt.user_name AS to_user_name, tmt.full_name AS to_name
				FROM ".prefix."tbl_cmsn_singleline AS tcd 
			  ...
			  WHERE 1 $StrWhr  ORDER BY tcd.single_id DESC";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Bonus <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Referral ROI	 Income </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
