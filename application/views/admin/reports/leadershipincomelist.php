<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	if($_GET['leadership_id']!=''){
		$leadership_id = _d($_GET['leadership_id']);
		$leadership = _e($leadership_id);
		$StrWhr .=" AND ldr.leadership_id='$leadership_id'";
		$SrchQ .="&leadership_id=$leadership";
	}

	
	$QR_PAGES= "SELECT ldr.net_income,ldr.left_pv,ldr.right_pv, tm.user_name AS username, tm.first_name,tm.midle_name,tm.last_name,tm.city_name FROM tbl_cmsn_leadership AS ldr LEFT JOIN tbl_members AS tm ON ldr.member_id=tm.member_id WHERE 1 $StrWhr ORDER BY ldr.leadership_id DESC";
                ...
                <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr role="row">
                      ...
                      <th  class="sorting">Left PV </th>
                      <th  class="sorting">Right PV</th>
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td data-title="City Name"><?php echo strtoupper($AR_DT['city_name']); ?></td>
                      <td data-title="Left PV"><?php echo $AR_DT['left_pv']; ?></td>
                       <td data-title="Right Pv"><?php echo $AR_DT['right_pv']; ?></td>
