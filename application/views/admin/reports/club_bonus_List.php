<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	$QR_PAGES="SELECT tcd.*, tm.user_id , CONCAT_WS(' ',tm.first_name,tm.last_name) AS full_name , tpt.pin_name
			   FROM ".prefix."tbl_cmsn_quick_club AS tcd 
                  ...
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title"> Reports <small> <i class="ace-icon fa fa-angle-double-right"></i>&nbsp; Club Bonus List</small>  </h4>
                        </div>
                             <div class="clearfix">
                ...
                <thead>
                    <tr role="row">
                      ...
                      <th  class="sorting">Username</th>
                         <th  class="sorting">Activation Date</th>
                  ...
                  <tbody>
                    <?php 
						...
						if($AR_DT['rank_id']==1){
						    $clubname='Royal Club';
						}elseif($AR_DT['rank_id']==2){
						     $clubname='Diamond Club';
						}elseif($AR_DT['rank_id']==3){
						    $clubname='Chairman Club';
						}elseif($AR_DT['rank_id']==4){
						    $clubname='Founder Club';
						}	
						  $MEMSUBSDETAILS = $model->getSubcriptionsdatanew($AR_DT['member_id']);	
							//	PrintR($MEMSUBSDETAILS['date_from']);
						?>
                    <tr class="odd" role="row">
                      <td data-title="Date"><?php echo getDateFormat($AR_DT['cmsn_date'],"d-m-Y"); ?></td>
                      <td data-title="Full Name"><?php echo $AR_DT['full_name']; ?></td>
                      <td data-title="Username"><?php echo $AR_DT['user_id']; ?></td>
                     <td data-title="Username"><?php echo getDateFormat($MEMSUBSDETAILS['date_from'],"d-m-Y"); ?></td>
                     ...
                     <td data-title="Amount"><?php echo CURRENCY; ?><?php echo $AR_DT['trans_amount']; ?></td>
                      ...
                      <td data-title="Net Total"><?php echo CURRENCY; ?><?php echo $AR_DT['net_income']; ?></td>
                       <td data-title="Plan"><?php echo $clubname; ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr class="odd" role="row">
