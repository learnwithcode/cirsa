                  ...
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title"> Reports <small> <i class="ace-icon fa fa-angle-double-right"></i>&nbsp; Mining Bonus List </small>  </h4>
                        </div>
 ...
 <thead>
                    <tr role="row">
                      ...
                      <th  class="sorting">Return (%) </th>
                       <th  class="sorting">Monthly Return (%) </th>
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td data-title="Amount"><?php echo number_format($AR_DT['trans_amount'],2); ?></td>
                      <td data-title="Return (%)"><?php echo number_format($AR_DT['daily_return'],2); ?> %</td>
                        <td data-title="Return (%)"><?php echo number_format($AR_DT['daily_return']*22); ?> % </td>
                      <td data-title="Net Total"><?php echo number_format($AR_DT['net_income'],2); ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr class="odd" role="row">
