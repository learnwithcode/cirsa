<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    $Page = $_GET[page]; if($Page == "" or $Page <=0){$Page=1;}
 	  ...
 	  $rankId = _d($_GET['rankId']);  
 	  
        $rnk =  $_GET['rankId'] ;
        $SrchQ .="&rankId=$rnk";
        $QR_PAGES= "SELECT  tm.user_name AS username, tm.first_name,tm.midle_name,tm.last_name,tm.city_name  FROM     tbl_members AS tm       WHERE tm.rank_id='$rankId'";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Bonus <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Rank Achievers List </small> </h1>
      </div>
                ...
                <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <!--<td data-title="Date Time"><?php echo DisplayDate($AR_DT['date_time']); ?></td>-->
                    ...
                    <?php $Ctrl++; endforeach;
						 ...
						 ?>
						 <tr><td colspan="7" align="center">No data found <a href="<?php echo generateSeoUrlAdmin("bonus","rankAchievers",""); ?>">Click here </a> go to back.</td></tr>
						 <?php } ?>
                  </tbody>
                </table>
              </div>
