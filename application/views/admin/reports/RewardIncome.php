...
$Page = $_REQUEST[page]; if($Page == "" or $Page <=0){$Page=1;}
	...
	$QR_PAGES= "SELECT R.*,COUNT(CR.reward_id) as total FROM `tbl_reward` as R LEFT JOIN tbl_cmsn_reward as CR on CR.reward_id =R.reward_id group by R.reward_id ";
                  ...
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title"> Reports <small> <i class="ace-icon fa fa-angle-double-right"></i>&nbsp; Rank Bonus </small>  </h4>
                        </div>
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                     ...
                     <td data-title="Status"><?php if(true){echo '<span class="label label-success arrowed">Success</span>';}else{ echo '<span class="label label-warning label-white middle">
                      ...
                      <td data-title="View"><?php if($AR_DT['total'] > 0) { ?><a href="<?php echo generateSeoUrlAdmin("reports","rewardList",""); ?>?reward_id=<?php echo _e($AR_DT['reward_id']); ?>">View</a><?php } else { ?> <a href="javascript:void(0);" onClick="alert('There is no Reward Achiver`s!');">View</a><?php } ?></td>
