<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	$QR_PAGES= "SELECT tcd.*, tmf.user_name AS from_user_name, tmt.user_name AS to_user_name, tmt.full_name AS to_name
				FROM ".prefix."tbl_cmsn_bonus AS tcd 
               ...
               <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td data-title="Net Income"><?php echo number_format($AR_DT['total_income'],2); ?></td>
                    </tr>
                    <?php $Ctrl++; endforeach;
						}
						 ?>
