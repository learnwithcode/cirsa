<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	if($_GET['month'] !='' && $_GET['year'] !='')
	{
	    $month = $_GET['month'];
	    $year = $_GET['year'];
	 	$StrWhr .="  AND red.year='$year' AND red.month='$month'";
	    $SrchQ .="&month=$month&year=$year";
	}

	
	$QR_PAGES= "SELECT red.*,ldr.name as deg_name, tm.user_id as username , tm.first_name as fname , tm.midle_name as mname , tm.last_name as lname ,tm.city_name as city 
				FROM ".prefix."tbl_cmsn_red AS red 
			   LEFT JOIN tbl_members AS tm ON red.member_id=tm.member_id
			   LEFT JOIN tbl_leadership AS ldr ON red.leadership_type=ldr.leadership_id
			  WHERE 1 $StrWhr ";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Bonus <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Turbo Sale Income List </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
               ...
               <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td data-title="Member Id"><?php echo strtoupper($AR_DT['username']); ?></td>
                      <td data-title="name"><?php echo strtoupper($AR_DT['fname'].' '.$AR_DT['mname'].' '.$AR_DT['lname'] ); ?></td>
                      <td data-title="From Member Id"><?php echo strtoupper($AR_DT['city']); ?></td>
                      <td data-title="Amount"><?php echo strtoupper($AR_DT['deg_name']); ?></td>
