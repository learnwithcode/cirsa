<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	$QR_PAGES="SELECT tcd.*,count(tcd.id) as total,sum(tcd.net_income) as net, tm.user_id  
			   FROM ".prefix."tbl_cmsn_pool AS tcd 
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Bonus <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Pool Income </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
					 <td data-title="Sn No"><?php echo $Ctrl;$Ctrl++;?></td>
                      ...
                      <td data-title="Net Total"><a href="<?php echo generateSeoUrlAdmin("bonus","poolIncomeList",""); ?>?process_id=<?php echo $AR_DT['process_id']; ?>">View</a><?php //echo number_format($AR_DT['total_income'],2); ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr class="odd" role="row">
