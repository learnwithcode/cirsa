...
//	$QR_PAGES= "SELECT rd.matching_pv,rd.net_income, tm.user_name AS username,r.description, tm.first_name,tm.midle_name,tm.last_name,tm.city_name FROM tbl_cmsn_reward AS rd LEFT JOIN tbl_members AS tm ON rd.member_id=tm.member_id  LEFT JOIN tbl_reward AS r ON rd.reward_id=r.reward_id WHERE rd.reward_id='$rewardId'";
	...
	$QR_PAGES= "SELECT  r.*,tm.user_name AS username, tm.first_name,tm.midle_name,tm.last_name,tm.city_name FROM  tbl_members AS tm  LEFT JOIN tbl_cmsn_reward AS r ON tm.member_id=r.member_id WHERE r.reward_id='$rewardId'";
                  ...
                  <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title"> Reports <small> <i class="ace-icon fa fa-angle-double-right"></i>&nbsp; Infinity Rewards </small>  </h4>
                        </div>
                        <div class="clearfix">
                <div class="pull-right tableTools-container">
                  <div class="dt-buttons btn-overlap btn-group">
                    <a  href="<?php echo generateSeoUrlAdmin("excel","reward_list",""); ?>/<?php echo $rewardId; ?>"  aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-csv buttons-html5 btn btn-white btn-primary btn-bold"><span><i class="fa fa-database bigger-110 orange"></i> <span class="hidden">Export to CSV</span></span></a> 
                  ...
                  <thead>
                    <tr role="row">
                      ...
                      <th  class="sorting">Reward Bonus </th>
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td data-title="Net Income"><?php echo CURRENCY; ?><?php echo  $AR_DT['net_income']; ?></td>
