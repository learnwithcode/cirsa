<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	$QR_PAGES= "SELECT COUNT(`direct_id`) as totalid , SUM(`net_income`) as income , process_id,date_time FROM `tbl_cmsn_bonus` WHERE 1 GROUP BY `process_id`";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Bonus <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Turbo Sale Bonus Income </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
                 ...
                 <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td data-title="Net Income"><a href="<?php echo generateSeoUrlAdmin("bonus","turbosaleincomelist",""); ?>?process_id=<?php echo $AR_DT['process_id']; ?>">View</a><?php //echo number_format($AR_DT['total_income'],2); ?></td>
                    </tr>
                    <?php $Ctrl++; endforeach;
						}
						 ?>
