...
$Page = $_REQUEST[page]; if($Page == "" or $Page <=0){$Page=1;}
	...
	$QR_PAGES="SELECT tcd.*, tm.user_id,tm.first_name FROM ".prefix."tbl_cmsn_singleline AS tcd 
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      ...
      <div class="row">
        ...
        <h1> Bonus <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Club Income </small> </h1>
      </div>
                 ...
                 <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td data-title="name"><?php echo strtoupper($AR_DT['first_name']); ?></td>
                    
                     
                      <td data-title="Net Income"><?php echo  $AR_DT['pair']; ?></td>
                    </tr>
                    <?php $Ctrl++; endforeach;
						}
						 ?>
