...
if($_POST['trns_for']!=''){
	$trns_for = FCrtRplc($_POST['trns_for']);
	$StrWhr .=" AND tft.trns_for='$trns_for'";
	$SrchQ .="&wallet_id=$trns_for";
}
if($_POST['user_id']!=''){
	$member_id = $model->getMemberId($_POST['user_id']);
  ...
  $QR_PAGES= "SELECT tft.*,tmt.first_name AS first_name, tmt.last_name AS last_name,tmt.midle_name as midle_name, tmt.user_id  AS user_id
			 ...
			 WHERE tft.wallet_id ='20' and tft.trns_for ='UTILITY'  
...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Financial <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; View Wallet Recharge  Transaction </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
 ...
 <!-- <style>-->
 <!--     .primary{    background-color: #5959c982 !important;}-->
 <!-- </style>-->
 ...
 <!--</div>-->
                <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
			       ...
			       ?>
                    <tr <?php if($AR_DT['trns_for']=='REF'){echo 'class="danger"';}elseif($AR_DT['trns_for']=='API'){echo 'class="success"';}elseif($AR_DT['trns_for']=='VW'){echo 'class="primary"';}else{ echo 'class="warning"';}?>>
                      ...
                      <td data-title="Status">
                       <?php if($AR_DT['trns_for']=='REF'){echo 'Refund';}elseif($AR_DT['trns_for']=='UTILITY'){echo 'Recharge';}elseif($AR_DT['trns_for']=='VW'){echo 'Wallet Credit';} ?>
