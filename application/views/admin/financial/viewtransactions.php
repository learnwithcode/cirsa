...
if($_POST['wallet_id']!=''){
	$wallet_id = FCrtRplc($_POST['wallet_id']);
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Financial <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; View Transaction </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
              ...
              <div class="col-xs-12">
                <form action="<?php echo ADMIN_PATH."financial/viewtransactions"; ?>" method="post" name="form-search" id="form-search">
                  <div class="form-group">
					...
					<select name="wallet_id" class="col-xs-12 col-sm-12 validate[required] form-control" id="wallet_id">
                    <option value="">select wallet</option>
                    <?php DisplayCombo($_REQUEST['wallet_id'],"WALLET"); ?>
                  </select>
				  </div>
                    <div class="col-sm-3">
