              ...
              <div class="col-lg-12">
                ...
                <div class="pull-right tableTools-container">
                  <div class="dt-buttons btn-overlap btn-group">
                    <a  href="<?php echo generateSeoUrlAdmin("excel","payoutpending",""); ?>"  aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-csv buttons-html5 btn btn-white btn-primary btn-bold"><span><i class="fa fa-database bigger-110 orange"></i> <span class="hidden">Export to CSV</span></span></a> 
             ...
             ?>
                        ...
                        <td data-title="Action" class="">
                          ...
                          <td class="sorting_1"><?php echo CURRENCY; ?><?php echo number_format($AR_DT['initial_amount'],2); ?> </td>
                                   <td class="sorting_1"  style=" width: 15%;display:none;"><?php echo CURRENCY; ?><?php echo number_format($AR_DT['liquidity'],2); ?> </td>
                                   <td class="sorting_1"  style=" width: 15%;display:none;"><?php echo CURRENCY; ?><?php echo number_format($AR_DT['stacking'],2); ?> </td>
                                      <td class="sorting_1">
                                          <?php if($AR_DT['cryptoname']=='Dizi Token'){ ?>
                                          DGC  
                                      <?php }else{?>
                                     ...
                                     <?php echo number_format($AR_DT['admin_charge'],2); ?> </td>
                                      </td>
                                      ...
                                      <td style="display:none;"  data-title="Admin Charge"><?php echo $Tyype; ?>
                                        <!--<td class="sorting_1">USDT Bep20 </td>-->
              ...
              ?>
               <input type="hidden" id="cplcrpaddress<?php echo $Ctrl; ?>"  class="form-control" style="cursor: no-drop; width: 100%" readonly value="<?php echo $AR_DT['trx_address'];?>">
                <span  onclick="copylinkaddress('<?php echo $AR_DT['trx_address'];?>')" class="btn label-lg btn-danger arrowed-in arrowed-in-right"><?php echo strtoupper($AR_DT['trx_address']); ?> </span
                     ...
                     <td> <input  placeholder="Update Remarks"  name="remarks" autocomplete="off" required class="form-control" value="<?php echo $AR_DT['remarks']; ?>" type="text" style="width: auto;">
					  </td>
                       ...
                       <td   data-title="Status">
                        ...
                        <td  data-title="Status"><?php if($AR_DT['trns_status']=="C"){ ?>
                            ...
                            <?php }else{ ?>
                             ...
                             <?php if($AR_DT['cryptoname']=='USDT'){ ?>
                            
                              <a href="<?php echo generateSeoUrlAdmin("financial","withdrawlapibusdtdemolive",array("member_id"=>$AR_DT['from_member_id'])); ?>/id/<?php echo $AR_DT['transfer_id']; ?>" onClick="return confirm('Make sure want to approved this  withdrawal request')" class="btn btn-success arrowed-in arrowed-in-right">Confirm</a> &nbsp;&nbsp; 
                      <?php }else{ ?>
                          
                          
                            <a style="display:none;" href="<?php echo generateSeoUrlAdmin("financial","withdrawals",array("transfer_id"=>_e($AR_DT['transfer_id']),"trns_status"=>_e("C"),"action_request"=>"confirmWithdraw")); ?>" onClick="return confirm('Make sure want to approved this  withdrawal request')" class="btn btn-success arrowed-in arrowed-in-right">Confirm</a> &nbsp;&nbsp; 
                       
                           <input id="transfer_id"  placeholder="Update Remarks"  name="transfer_id" autocomplete="off" value='<?php echo _e($AR_DT['transfer_id']);?>' class="form-control validate[required,custom[integer]]" type="hidden" >
                         <input id="trns_status"  placeholder="Update Remarks"  name="trns_status" autocomplete="off" value='<?php echo _e("R");?>' class="form-control validate[required,custom[integer]]" type="hidden" >
                         
                         
                            <button type="submit" class="btn btn-success" name="confirmWithdraw" value='1' >Confirm</button>
                        ...
                        <?php }else{ ?>
                         ...
                         <td colspan="12"><button type="submit" class="btn btn-success" name="confirmWithdraw" value="1" >Confirm</button>
