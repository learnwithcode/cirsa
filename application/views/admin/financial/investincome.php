    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> E-Wallet <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Signup Wallet </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <?php get_message(); ?>
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-12" style="min-height:500px;">
                ...
                <form action="<?php echo generateAdminForm("financial","investincome","");?>" method="post" name="form-search" id="form-search">
