...
$QR_PAGES="SELECT cr.member_id as mid ,mem.user_id as userId, mem.first_name as fname ,mem.midle_name as mname, mem.last_name as lname, SUM(cr.trns_amount) as credit FROM `tbl_wallet_trns` as cr 
LEFT JOIN tbl_members as mem on cr.member_id = mem.member_id 
WHERE trns_type='Cr' $StrWhr GROUP BY cr.member_id ORDER BY SUM(cr.trns_amount) DESC";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Financial <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; Income Report </small> </h1>
        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-12">
                ...
                <div>
                      ...
                      <form action="<?php echo generateAdminForm("financial","incomereport","");  ?>" method="post">
                  <table id="" class="table">
                    ...
                    <tbody>
			 	 	...
			 	 	if($PageVal['TotalRecords'] > 0){
						...
						$AR_BAL = $model->getCurrentBalance($AR_DT['mid'],$wallet_id,"","");
			       ?>
			...
			<?php echo $Ctrl;?>
			       ...
			       <td><?php echo strtoupper($AR_DT['userId']); ?></td>
			       <td><a href="javascript:void(0)"><?php echo strtoupper($AR_DT['fname']." ".$AR_DT['mname']." ".$AR_DT['lname']); ?></a></td>
			       <td><?php echo $AR_DT['credit']; ?></td>
			       <td><?php echo $AR_BAL['total_amount_dr'];?></td>
			       <td><?php echo $AR_BAL['net_balance'];?></td>
