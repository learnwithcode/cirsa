...
if($_GET['trns_status']!=''){
   ...
   $QR_PAGES= "SELECT tft.*,tmt.first_name AS first_name, tmt.last_name AS last_name,tmt.midle_name as midle_name, tmt.user_id  AS user_id
			 FROM ".prefix."tbl_coinpayment AS tft 
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Financial <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; CoinPayment Deposit History </small> </h1>
              ...
              <div class="col-xs-12">
                  <div class="pull-right tableTools-container">
                      ...
                      <a  class="dt-button buttons-copy buttons-html5 btn btn-white btn-primary btn-bold open_modal"><span><i class="fa fa-search bigger-110 pink"></i> <span class="hidden">Search</span></span></a>
                        <a href="<?php echo BASE_PATH; ?>superadmin/financial/coinpaymentHistory" title="" data-original-title="" aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-collection buttons-colvis btn btn-white btn-primary btn-bold"><i class="fa fa-refresh bigger-110 pink"></i></a>
							    ...
							    ?>
                                    <tr class="odd" role="row">
                                     ...
                                     ?>
                                       ...
                                       <a href="<?php echo BASE_PATH;?>superadmin/financial/updateDepositLink/<?php echo _e($AR_DT['id']);?>/<?php echo _e('Y');?>" class="btn btn-success btn-sm mr-2" style="border-radius: 12px;" >Approve</a>
                                    
                                      <a href="<?php echo BASE_PATH;?>superadmin/financial/updateDepositLink/<?php echo _e($AR_DT['id']);?>/<?php echo _e('N');?>" class="btn btn-danger btn-sm mr-2"   style="border-radius: 12px;" >Cancel</a>
                                     ...
                                     <span class="label label-danger arrowed-in arrowed-in-right">Rejected</span>
                                      <?php }    ?>    
                                   
                                      </td>
                                      <!--<td><a href="<?php echo $AR_DT['status_url'];?>"  target="_blank"  >View</a></td>-->
                                    </tr>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" autocomplete="off" method="get">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Select Coin :</label>
              <div class="col-sm-7">
               <select name="trns_coin" class="col-xs-12 col-sm-6   form-control" id="trns_coin">
                
                    <option value ="">Select</option>
                     <option value="TRX" <?php if($_GET['trns_coin']=='TRX'){ echo 'selected';}?>>TRX</option>
                      <option value="EGC" <?php if($_GET['trns_coin']=='EGC'){ echo 'selected';}?>>EGC</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
               <select name="trns_status" class="col-xs-12 col-sm-6   form-control" id="trns_status">
                
                    <option value ="">Select</option>
                     <option value="Y" <?php if($_GET['trns_status']=='Y'){ echo 'selected';}?>>Success</option>
                      <option value="N" <?php if($_GET['trns_status']=='N'){ echo 'selected';}?>>Pending</option>
                       <option value="R" <?php if($_GET['trns_status']=='R'){ echo 'selected';}?>>Reject</option>
                  </select>
              </div>
            </div>
