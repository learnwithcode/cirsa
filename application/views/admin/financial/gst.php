...
$QR_PAGES="SELECT SUM(pin.mrp) as total ,SUM(pin.amount) as net ,SUM(pin.tax) as tax, sum(pin.mrp) as price,sum(pin.tax_amt) as tamt, sub.date_from as month,count(sub.subcription_id) as totalid FROM tbl_subscription as sub LEFT JOIN tbl_pintype as pin on sub.type_id = pin.type_id WHERE sub.package_price > 0 group BY YEAR(sub.date_from),MONTH(sub.date_from) DESC";
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="" class="table">
			       ...
			       <tr class="warning">
			       <td><?php echo $Ctrl; ?></td>
			       <td><?php echo  date('F-Y', strtotime($AR_DT['month'])); ?></td>
			        <td> <?php echo $AR_DT['totalid'];?>  </td>
			       <td>&#8377;&nbsp;<?php echo $AR_DT['net'];?> /-</td>
			       <td>&#8377;&nbsp;<?php echo $AR_DT['tamt'];?> /-</td>
			       
			       <td>&#8377;&nbsp;<?php echo $AR_DT['price'];?> /-</td>
			 <td><a href="<?php echo BASE_PATH;?>superadmin/financial/gstList?month=<?php echo _e($AR_DT['month']);?>" >View</a></td>
			        </tr>
			        <div class="clearfix"></div>
                      ...
                      <?php $Ctrl++; endforeach; ?>
                        ...
                        <th colspan="2">Total Report</th>
                        
                        <th> <?php echo $totalid;?>  </th>
                       <th>&#8377;&nbsp;<?php echo $net;?> /-</th>
                        <th>&#8377;&nbsp;<?php echo $tax;?> /-</th>
