...
$model = new OperationModel();
    $tds = $_GET[tds]; if($tds == ""){redirect('financial','tdsdeduction');}
  $tdsdate =  _d($tds);
  $Page = $_GET['page']; if($Page=="" || $Page <=0 ){$Page=1;}
	$date = date('y-m',strtotime($tdsdate));
	
$QR_PAGES="SELECT mem.user_id as userid , mem.first_name as fname , mem.midle_name as mname , mem.last_name as lname , SUM(mst.tds) as totaltds FROM tbl_cmsn_mstr as mst LEFT JOIN tbl_members as mem on mst.member_id = mem.member_id WHERE mst.pay_sts_date LIKE '%$date%' GROUP BY mst.member_id HAVING(SUM(mst.tds) > 0)";
    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> Financial <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; TDS Deduction Report </small> </h1>
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="" class="table">
			       ...
			       <td><?php echo  strtoupper($AR_DT['fname'].' '.$AR_DT['mname'].' '.$AR_DT['lname']); ?></td>
			       <td><?php echo $AR_DT['totaltds'];?></td>
