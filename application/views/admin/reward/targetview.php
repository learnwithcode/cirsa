<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	$QR_PAGES= "SELECT * FROM tbl_target ";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Reward <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Target Type</small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
...
<a  href="<?php echo generateSeoUrlAdmin("reward","updatetarget/",""); ?>" aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-print btn btn-white btn-primary btn-bold"><span> Add New  <i class="fa fa-plus bigger-110 grey"></i></span></a>
				   </div>
                </div>
              </div>
                ...
                <table id="no-more-tables" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr role="row">
                      ...
                      <th  class="sorting">Target Name</th>
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
					  ...
					  <td data-title="Target Name"><?php echo $AR_DT['targetName']; ?></td>
                      ...
                      <td data-title="Action"><a href="<?php echo generateSeoUrlAdmin("reward","targettype/"._e($AR_DT['target_id']),""); ?>">View</a></td>
