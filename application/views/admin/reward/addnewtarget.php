  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <!-- PAGE CONTENT BEGINS -->
          <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."reward/updatetarget/".$targetId; ?>" method="post">
            <div class="form-group">
              <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Target Name </label>
              <div class="col-sm-9">
                <input id="form-field-1" placeholder="Target name" name="targetName"  class="col-xs-10 col-sm-5 validate[required]" type="text" value="<?php echo $ROW['targetName']; ?>">
              </div>
            </div>
			<div class="form-group">
              ...
              <div class="col-sm-3">
                <div class="input-group">
                  <input class="form-control col-xs-6 col-sm-3  validate[required] date-picker" name="fdate" id="id-date-picker-1" value="<?php echo $ROW['fdate']; ?>" type="text"  />
            ...
            <div class="space-4"></div>
              ...
              <div class="col-md-offset-3 col-md-9">
                ...
                <button onClick="window.location.href='<?php echo ADMIN_PATH."reward/targetview"; ?>'"  class="btn" type="button"> <i class="ace-icon fa fa-undo bigger-110"></i> Cancel </button>
              </div>
            </div>
          </form>
          <!-- PAGE CONTENT ENDS -->
