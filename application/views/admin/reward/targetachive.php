  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Reward <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp;Target Achived List </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
...
<!--<a  href="#<?php //echo generateSeoUrlAdmin("excel","targetachive",""); ?>" data-original-title="" aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-csv buttons-html5 btn btn-white btn-primary btn-bold"><span><i class="fa fa-database bigger-110 orange"></i> <span class="hidden">Export to CSV</span></span></a> 
...
<a  onClick="window.print()" aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-print btn btn-white btn-primary btn-bold"><span><i class="fa fa-print bigger-110 grey"></i> <span class="hidden">Print</span></span></a>
              ...
              <form action="<?php echo ADMIN_PATH."reward/targetachive"; ?>" method="get" name="form-search" id="form-search">
                <div class="form-group">
                  <div class="col-sm-3">
                    <input id="form-field-1" placeholder="From Date" value="<?php echo $_GET['from_date'];?>" name="from_date"  class="col-xs-10 col-sm-12 validate[required]" type="date">
                  </div>
				                    <div class="col-sm-3">
                    <input id="form-field-1" placeholder="To Date" value="<?php echo $_GET['to_date'];?>" name="to_date"  class="col-xs-10 col-sm-12 validate[required]" type="date">
                  </div>
                  <div class="col-sm-6">
                  ...
                  <tbody>
                    <?php 
						...
						$right = $model->getrightleft($member_id,"R",$fdate,$edate);
							if($left >=5 and $right >= 5){
							  ...
							  //if($left >=80){ $l=1; } else{$l=0;}
							   // if($right >=80){ $r=1; } else{$r=0;}
							    
							   // if(($l=='1' && $r =='0') || ($l=='0' && $r =='1') || ($l=='0' && $r =='0')){
                    ...
                    <tr class="odd" role="row">
                     ...
                     <!-- <td data-title="Date"><?php echo getDateFormat($AR_DT['date_time'],"d M Y"); ?></td>-->
                       <td data-title="distributor id"><?php echo $AR_DT['user_name']; ?></td>
					  <td data-title="name"><?php echo $AR_DT['first_name'].' '.$AR_DT['last_name']; ?></td>
					  <td data-title="name"><?php echo $AR_DT['member_mobile']; ?></td>
                      <td data-title="City"><?php echo $AR_DT['city_name']; ?></td>
                      <td data-title="Left"><?php echo $left; ?></td>
                      <td data-title="Right"><?php echo $right; ?></td>
