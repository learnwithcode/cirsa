...
$QR_PAGES= "SELECT tpm.*, tpy.pin_name, tpy.pin_letter, tm.user_id FROM ".prefix."tbl_pinsmaster AS tpm 
              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['mstr_id']; ?> <span class="lbl"></span> </label>
                        </td>
