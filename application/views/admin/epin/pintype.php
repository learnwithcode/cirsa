...
$QR_PAGES="SELECT tpy.* FROM ".prefix."tbl_pintype AS tpy WHERE tpy.isDelete>0 $StrWhr ORDER BY tpy.type_id ASC";
                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                       ...
                       <!-- <th width="163">Days</th>
                        <th width="163">Investment  (BTC) </th>
                        <th width="133">R.O.I % </th>
                        <th width="133">Direct Ref. % </th>
                        <th width="133">Binary. % </th>
                        <th width="78">Featured</th>-->
                         <th width="163">Total PV </th>
						  <th width="163">Total Price </th>
			       ...
			       ?>
                      <tr>
                       ...
                       <!-- <td><?php echo number_format($AR_DT['no_day']); ?></td>
                        <td><?php echo $AR_DT['pin_price']; ?></td>
                        <td><?php echo $AR_DT['daily_return']; ?></td>
                        <td><?php echo $AR_DT['direct_bonus']; ?></td>
                        <td><?php echo $AR_DT['binary_bonus']; ?></td>
                        <td><?php echo ($AR_DT['featured_sts']>0)? "Yes":"No"; ?></td>-->
                         <td><?php echo $AR_DT['pin_price']; ?> &nbsp;[<?php echo $AR_DT['pin_letter']; ?>]</td>
