...
$QR_PAGES= "SELECT tpd.*, tm.user_id, tm.first_name, tm.last_name, tpy.pin_name
			...
			LEFT JOIN ".prefix."tbl_pintype AS tpy ON tpd.type_id=tpy.type_id WHERE tpd.pin_sts='N' AND tpd.use_member_id>0 $StrWhr ORDER BY tpd.pin_id ASC";
              ...
              <div class="col-xs-12">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."epin/unusedpin"; ?>" method="post">
