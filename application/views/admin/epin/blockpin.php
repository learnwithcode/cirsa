...
$QR_PAGES= "SELECT tpd.*, tm.user_id, tm.first_name, tm.last_name, tpy.pin_name FROM ".prefix."tbl_pinsdetails AS tpd 
			...
			LEFT JOIN ".prefix."tbl_pintype AS tpy ON tpd.type_id=tpy.type_id WHERE tpd.pin_sts='N' $StrWhr ORDER BY tpd.pin_id ASC";
