    ...
    <div class="main-content-inner">
      ...
      <div class="page-content">
        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."epin/pingenerate"; ?>" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input id="pin_price" readonly="true" placeholder="Pin Price"  name="pin_price"  class="col-xs-5 col-sm-5 validate[required]" type="text" value="<?php echo $ROW['pin_price']; ?>">
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input name="net_amount" type="text" class="col-xs-5 col-sm-5 validate[required]" id="net_amount" value="<?php echo $ROW['net_amount']; ?>" readonly="true">
                </div>
              </div>
              <div class="space-4"></div>
              <div class="form-group">
