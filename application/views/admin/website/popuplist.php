...
$QR_PAGES="SELECT pop.* FROM ".prefix."tbl_popup_data AS pop   WHERE 1  ORDER BY pop.popup_id ASC";
              ...
              <div class="col-lg-12">
                  <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title"> Website <small> <i class="ace-icon fa fa-angle-double-right"></i>&nbsp;Popup List </small>  </h4>
                        </div>
                ...
                <div class="pull-right tableTools-container">
                  <div class="dt-buttons btn-overlap btn-group"> 
                         <a  href="<?php echo generateSeoUrlAdmin("website","popupadd",""); ?>" data-original-title="" aria-controls="dynamic-table" tabindex="0" class=" btn btn-white btn-primary btn-bold"><span><i class="fa fa-plus bigger-110 blue"></i> <span class="">Add New Popup</span></span></a> 
              ...
              <!--          <td align="left">   <label>
                        ...
                        <td align="center"><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("website","popupadd",array("popup_id"=>$AR_DT['popup_id'],"action_request"=>"EDIT")); ?>">Edit</a> </li>
                            <li> <a onClick="return confirm('Make sure want to delete this Image ?')" href="<?php echo generateSeoUrlAdmin("website","popupadd",array("popup_id"=>$AR_DT['popup_id'],"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <?php $Ctrl++; endforeach; ?>
