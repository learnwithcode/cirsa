...
$QR_PAGES="SELECT bnr.* FROM ".prefix."tbl_banner AS bnr   WHERE 1 $StrWhr ORDER BY bnr.banner_id ASC";
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Banner  <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; List </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
              ...
              <!--<div class="clearfix">
                <div class="pull-right tableTools-container">
                  <div class="dt-buttons btn-overlap btn-group"> 
                    <a  href="<?php echo generateSeoUrlAdmin("website","banneradd",""); ?>" data-original-title="" aria-controls="dynamic-table" tabindex="0" class="dt-button buttons-csv buttons-html5 btn btn-white btn-primary btn-bold"><span><i class="fa fa-plus bigger-110 orange"></i> <span class="hidden">Add New Banner</span></span></a> </div>
                </div>
              </div>-->
              <div>
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  ...
                  <form method="post" autocomplete="off" action="<?php echo ADMIN_PATH."operation/cms"; ?>">
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['banner_id']; ?> <span class="lbl"></span> </label>                        </td>
                        <td align="left"><?php echo $AR_DT['banner_title']; ?></td>
						<td><img src="<?php echo BASE_PATH.'upload/banner/'.$AR_DT['image'];?>" width="240px" height="120px"><?php //echo $AR_DT['banner'];?></td>
                        <td align="left"><a href="javascript:void(0)"><?php echo $AR_DT['url']; ?></a></td>
                        
                        <td align="center">
							<label>
							<input name="switch-field-1" onclick="return updatestatus(<?php echo $AR_DT['banner_id'];?>);" class="ace ace-switch ace-switch-4 checkStatus" <?php if($AR_DT['status']>0){ echo 'checked="checked"';} ?>  type="checkbox" id="<?php echo $AR_DT['banner_id'];?>">
                        ...
                        <td align="center"><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("website","banneradd",array("banner_id"=>$AR_DT['banner_id'],"action_request"=>"EDIT")); ?>">Edit</a> </li>
...
jQuery.ajax({
type:"POST",
url :"<?php echo BASE_PATH;?>"+"superadmin/website/bannerstatus",
