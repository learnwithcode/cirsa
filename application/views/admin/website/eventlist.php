                  ...
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th width="103" align="center">Event Title</th>
                        <th width="81" align="center">Event Date </th>
			       ...
			       ?>
                      <tr>
                        <td class="center"><label class="pos-rel"> <?php echo $AR_DT['event_id']; ?> <span class="lbl"></span> </label>
                        </td>
                        <td align="left"><a href="javascript:void(0)"><?php echo $AR_DT['event_title']; ?></a> </td>
                        <td align="left"><?php echo ($AR_DT['e_day'])."-".($AR_DT['e_month'])."-".($AR_DT['e_year']); ?></td>
                        <td align="left"><?php echo setWord(strip_tags($AR_DT['event_detail']),200); ?></td>
                        <td align="center"><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("operation","event",array("event_id"=>_e($AR_DT['event_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              <li> <a onClick="return confirm('Make sure want to delete this record?')" href="<?php echo generateSeoUrlAdmin("operation","event",array("event_id"=>_e($AR_DT['event_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <?php $Ctrl++; endforeach; ?>
