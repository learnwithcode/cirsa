              ...
              <div class="col-xs-12">
                ...
                <div>
                  <table id="dynamic-table" class="table table-striped table-bordered table-hover">
			       ...
			       ?>
                        <tr>
                          <td class="center"><label class="pos-rel"> <?php echo $AR_DT['news_id']; ?> <span class="lbl"></span> </label>
                          </td>
                          ...
                          <td align="center"><div class="btn-group">
                              ...
                              <ul class="dropdown-menu dropdown-default">
                                <li> <a href="<?php echo generateSeoUrlAdmin("operation","news",array("news_id"=>$AR_DT['news_id'],"action_request"=>"EDIT")); ?>">Edit</a> </li>
                                <li> <a onClick="return confirm('Make sure want to delete this record?')" href="<?php echo generateSeoUrlAdmin("operation","news",array("news_id"=>$AR_DT['news_id'],"action_request"=>"DELETE")); ?>">Delete</a> </li>
                              </ul>
                            </div></td>
                        </tr>
                        <?php $Ctrl++; endforeach; ?>
  ...
  <div id="search-modal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo ADMIN_PATH."operation/newslist"; ?>" method="post">
