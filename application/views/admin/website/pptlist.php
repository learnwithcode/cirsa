...
if($_REQUEST['ppt_name']!=''){
	$ppt_name = FCrtRplc($_REQUEST['ppt_name']);
	$StrWhr .=" AND ( tp.ppt_name = '%$ppt_lang%' )";
	$SrchQ .="&ppt_name=$ppt_name";
}

$QR_PAGES="SELECT tp.*, tc.country_name FROM ".prefix."tbl_ppt AS tp  
  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Ppt <small> <i class="ace-icon fa fa-angle-double-right"></i> &nbsp; List </small> </h1>
      </div>
      <!-- /.page-header -->
      <div class="row">
        <?php get_message(); ?>
            ...
            <div class="col-xs-12">
              ...
              <div>
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <th class="center"> <label class="pos-rel"> Srl # <span class="lbl"></span> </label>                      </th>
			       ...
			       ?>
                      <tr>
                        ...
                        <td align="left"><?php echo $AR_DT['ppt_name']; ?></td>
                        <td align="left"><span class="flag flag-<?php echo strtolower($AR_DT['ppt_country']); ?>"></span> &nbsp;<?php echo $AR_DT['country_name']; ?></td>
                        <td align="left"><a target="_blank" href="<?php echo $ppt_file_src; ?>"><?php echo $AR_DT['ppt_file']; ?></a></td>
                        <td align="left"><?php echo $AR_DT['ppt_lang']; ?></td>
                        <td align="left"><?php echo ($AR_DT['ppt_status']>0)? "Active":"In-Active"; ?></td>
                        <td align="center"><div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                              <li> <a href="<?php echo generateSeoUrlAdmin("operation","ppt",array("ppt_id"=>_e($AR_DT['ppt_id']),"action_request"=>"EDIT")); ?>">Edit</a> </li>
                              <li> <a onClick="return confirm('Make sure want to delete this record?')" href="<?php echo generateSeoUrlAdmin("operation","ppt",array("ppt_id"=>_e($AR_DT['ppt_id']),"action_request"=>"DELETE")); ?>">Delete</a> </li>
                            </ul>
                          </div></td>
                      </tr>
                      <?php $Ctrl++; endforeach; ?>
...
<div id="search-modal" class="modal fade" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal"  name="form-page" id="form-page" action="<?php echo generateAdminForm("operation","pptlist",""); ?>" method="post">
        <div class="modal-body">
          <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Title </label>
            <div class="col-sm-6">
              <input id="ppt_name" placeholder="Name of file" name="ppt_name"  class="col-xs-10 col-sm-12 validate[required]" type="text" value="<?php echo $_REQUEST['ppt_name']; ?>">
            </div>
          </div>
