          ...
          <div class="col-xs-12">
           ...
           <div class="widget-box">
              <div class="widget-header widget-header-blue ">
                <h4 class="widget-title lighter">Matching Income Closing</h4>
                    ...
                    <div class="no-steps-container" id="fuelux-wizard-container">
                      ...
                      <div class="step-content pos-rel">
                        <div class="step-pane active" data-step="1" id="pagedata" >
                          <h3 class="lighter block green"> Process Week </h3>
...
<!--		 <a href="<?php echo BASE_PATH;?>superadmin/closing/leadership"class="btn btn-danger"><i class="ace-icon fa fa-fast-forward"></i> Skip</a>-->
...
<script type="text/javascript">
	...
	var submitdata = document.getElementById("submitMemberSave").value;
	   ...
	   $("#submitMemberSave").prop('disabled', true);
			  jQuery.ajax({
				type: "POST",
				url: "<?php echo BASE_PATH; ?>" + "superadmin/closing/ajaxmatchingincome",
				data: {submitdata:submitdata},
				success: function(res) {
				window.location.href = "<?php echo BASE_PATH;?>superadmin/closing/turbobonus";
