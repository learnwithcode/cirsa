...
<div class="main-container ace-save-state" id="main-container">
  ...
  <div class="main-content">
                    ...
                    <div class="no-steps-container" id="fuelux-wizard-container">
                      ...
                      <div class="step-content pos-rel">
                        <div class="step-pane active" data-step="1" id="pagedata" >
                          <h3 class="lighter block green">Process Month </h3>
                          <div class="hr hr-dotted"></div>
                        
						 
						 
						  <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">From Month : </label>
    ...
    $yearMonth =  $dt->format('M-Y');
							   ?>
								                            <input class="col-xs-12 col-sm-5 validate[required]  date-picker" name="from_date" id="from_date1" value="<?php echo $yearMonth;?>" type="datetime" readonly>
	...
	<svg class="loader" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 340">
		 ...
		 <circle cx="170" cy="170" r="85" stroke="#404041"/>
	 		 ...
	 		 <a href="<?php echo BASE_PATH;?>superadmin/closing/totalcommission"class="btn btn-danger"><i class="ace-icon fa fa-fast-forward"></i> Skip</a>
...
<script type="text/javascript">
	...
	var submitdata = document.getElementById("submitMemberSave").value;
	   ...
	   $("#submitMemberSave").prop('disabled', true);
			  jQuery.ajax({
				type: "POST",
				url: "<?php echo BASE_PATH; ?>" + "superadmin/closing/ajaxredremuneration",
				data: {submitdata:submitdata},
				success: function(res) {
				window.location.href = "<?php echo BASE_PATH;?>superadmin/closing/totalcommission";
