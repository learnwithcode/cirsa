          ...
          <div class="col-xs-12">
           ...
           <div class="widget-box">
              <div class="widget-header widget-header-blue ">
                <h4 class="widget-title lighter">Leadership Closing</h4>
...
<script type="text/javascript">
	...
	var submitdata = document.getElementById("submitMemberSave").value;
	   ...
	   $("#submitMemberSave").prop('disabled', true);
			  jQuery.ajax({
				type: "POST",
				url: "<?php echo BASE_PATH; ?>" + "superadmin/closing/ajaxleadership",
				data: {submitdata:submitdata},                        
				success: function(res) {
				window.location.href = "<?php echo BASE_PATH;?>superadmin/closing/redremuneration";
