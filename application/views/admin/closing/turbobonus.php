  ...
  <div class="main-content">
          ...
          <div class="col-xs-12">
           ...
           <div class="widget-box">
              <div class="widget-header widget-header-blue ">
                <h4 class="widget-title lighter">Turbo Bonus Closing</h4>
              ...
              <div class="widget-body">
                    ...
                    <div class="no-steps-container" id="fuelux-wizard-container">
                      <div>
                        <ul style="margin-left: 0" class="steps">
                          ...
                          <li data-step="4"> <span class="step">4</span> <span class="title">LeaderShip Level Bonus </span> </li>
						   <li data-step="5"> <span class="step">5</span> <span class="title">Red Remuneration </span> </li>
						   
						    <li data-step="6"> <span class="step">6</span> <span class="title">Finish </span> </li>
                        </ul>
                      </div>
                      <hr>
                      <div class="step-content pos-rel">
                        <div class="step-pane active" data-step="1" id="pagedata" >
                          <h3 class="lighter block green">Please Select Process Week </h3>
				...
				$sel_query = $this->db->query("SELECT prs.* FROM tbl_process as prs LEFT JOIN `tbl_process_turbo` as tur on tur.pair_sts='N' WHERE prs.process_id >= tur.`process_id` and prs.pair_sts !='N' ORDER BY prs.process_id ASC");
		$fetchRow = $sel_query->result_array();
		
				foreach($fetchRow as $res){
				?>		 
						 
						  <div class="col-xs-12">
						  <div class="col-sm-6">
						  <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">From Date : </label>
                            <div class="col-xs-12 col-sm-9">
                              <div class="clearfix">
                               
								                            <input class="col-xs-12 col-sm-5 validate[required]  date-picker" name="from_date" id="from_date1" value="<?php echo $res['start_date'];?>" type="datetime" readonly>
                            <span class="input-group-addon" style="width: 21px;
    height: 40px;"> <i class="fa fa-calendar bigger-110"></i></span>
                              </div>
                            </div>
                          </div>
						  </div>
						  <div class="col-sm-6">
                          <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">End Date : </label>
                            <div class="col-xs-12 col-sm-9">
                              <div class="clearfix">
                               
								                            <input class="col-xs-12 col-sm-5 validate[required]  date-picker" name="from_date" id="from_date1" value="<?php echo $res['end_date'];?>" type="datetime" readonly>
                            <span class="input-group-addon" style="width: 21px;
    height: 40px;"> <i class="fa fa-calendar bigger-110"></i></span>
                              </div>
                            </div>
						  ...
						  <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                              <div class="clearfix">
								                            ...
								                            <input class="col-xs-12 col-sm-5 validate[required]  date-picker" name="from_date" id="from_date1" value="2018-06-16 00:00:00" type="datetime" readonly>
                            <span class="input-group-addon" style="width: 21px;
    height: 40px;"> <i class="fa fa-calendar bigger-110"></i></span>
                              </div>
                            </div>
	...
	<svg class="loader" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 340">
		 ...
		 <circle cx="170" cy="170" r="85" stroke="#404041"/>
		 		 ...
		 		 <a href="<?php echo BASE_PATH;?>superadmin/closing/leadership"class="btn btn-danger" id="skip"><i class="ace-icon fa fa-fast-forward"></i> Skip</a>
...
<script type="text/javascript">
	...
	var submitdata = document.getElementById("submitMemberSave").value;
	   ...
	   $("#skip").css('visibility', "hidden");
			  jQuery.ajax({
				type: "POST",
				url: "<?php echo BASE_PATH; ?>" + "superadmin/closing/ajaxturbobonus",
				data: {submitdata:submitdata},                         
				success: function(res) {
				window.location.href = "<?php echo BASE_PATH;?>superadmin/closing/leadership";
