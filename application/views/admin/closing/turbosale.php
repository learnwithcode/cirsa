...
<div class="main-container ace-save-state" id="main-container">
  ...
  <div class="main-content">
          ...
          <div class="col-xs-12">
           ...
           <div class="widget-box">
              <div class="widget-header widget-header-blue ">
                <h4 class="widget-title lighter">Turbo Sale Income Closing</h4>
                    ...
                    <div class="no-steps-container" id="fuelux-wizard-container">
                      <div>
                        <ul style="margin-left: 0" class="steps">
                          ...
                          <li data-step="2"> <span class="step">2</span> <span class="title">Matching Income</span> </li>
                          <li data-step="3"> <span class="step">3</span> <span class="title">Turbo Sale Bonus</span> </li>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                              <div class="clearfix">
								                            ...
								                            <input class="col-xs-12 col-sm-5 validate[required]  date-picker" name="from_date" id="from_date1" value="<?php echo $start_date;?>" type="datetime" readonly>
						  ...
						  <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                              <div class="clearfix">
								                            ...
								                            <input class="col-xs-12 col-sm-5 validate[required]  date-picker" name="from_date" id="from_date1" value="<?php echo $end_date;?>" type="datetime" readonly>
                            <span class="input-group-addon" style="width: 21px;
    height: 40px;"> <i class="fa fa-calendar bigger-110"></i></span>
                              </div>
                            </div>
	...
	<svg class="loader" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 340">
		 ...
		 <!--<a href="#"class="btn btn-danger"><i class="ace-icon fa fa-fast-forward"></i> Skip</a>-->
...
<script type="text/javascript">
	...
	var submitdata = document.getElementById("submitMemberSave").value;
	   ...
	   $("#submitMemberSave").prop('disabled', true);
			  jQuery.ajax({
				type: "POST",
				url: "<?php echo BASE_PATH; ?>" + "superadmin/closing/ajaxturbosale",
				data: {submitdata:submitdata},
				success: function(res) {
				window.location.href = "<?php echo BASE_PATH;?>superadmin/closing/matchingincome";
