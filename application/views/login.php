...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
   ...
   <script>
          document.getElementById("loginshine").disabled = false;
          
          $( ".form-login" ).on( "submit", function( event ) {
         event.preventDefault();
         // document.getElementById("loginshine").disabled = true;
               ...
               if(JsonEval.ErrorMsg!=''){
                  switch(JsonEval.ErrorMsg){
                     case "success":
                       ...
                       $("#error-msg").html('<div class="alert alert-success alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>'+ JsonEval.ErrorDtl +'</div>');                                     

                         window.location.href='<?php echo MEMBER_PATH; ?>';
                     break;
                     case "invalid":
           $("#error-msg").html('<div class="alert alert-danger alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>'+ JsonEval.ErrorDtl +'</div>');                                     
