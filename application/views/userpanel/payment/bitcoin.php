<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	if($AR_COIN['coinbase_id']=='' || $AR_COIN['coinbase_id']=='0' || !isset($AR_COIN['coinbase_id'])){	
		...
		$this->OperationModel->setBitcoinProcessUrl($coinbase_id,$type_id,$trns_type,"depositebitcoin");
    ...
    <script>	
		...
		$(function(){
			...
			function check_payment_status(){
				...
				var URL_LOAD= "<?php echo BASE_PATH; ?>json/jsonhandler?switch_type=BITCOIN_PAYMENT_WALLET";
				var data = {
