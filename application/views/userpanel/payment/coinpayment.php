<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	$custom = $member_id."-".$order_no."-".$deposit_amount."-".$trns_type;
 ?>
...
<body>
	<div class="container">
    	<div class="row">
			...
			<div align="center"><img src="<?php echo BASE_PATH; ?>assets/setuimages/loading75.gif"/></div>
			...
			<form action="https://www.coinpayments.net/index.php" id="coinPayment" name="coinPayment" method="POST">
					...
					<input name="currency" value="BTC" type="hidden">
					...
					<input name="address2" value="<?php echo $AR_MEM['city_name']; ?>" type="hidden">		
					<input name="city" value="Thane" type="hidden">
					...
					<input name="ipn_url" value="<?php echo generateSeoUrl("cronjob","bitpayment",""); ?>/bitpayment.php" type="hidden">
					<input name="success_url" value="<?php echo generateSeoUrlMember("payment","coinpaymentconfirm",""); ?>" type="hidden">
