<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	if(!$this->session->userdata('order_no')){
		...
		$model->setMemberPerfectMoney($member_id,$deposit_amount,$order_no,$trns_type,$type_id);
	}else{
...
<body>
	<div class="container">
    	<div class="row">
			...
			<input type="hidden" name="PAYMENT_URL" value="<?php echo generateMemberForm("payment","perfectconfirmupgrade",""); ?>">
			...
			<input type="hidden" name="BAGGAGE_FIELDS" value="MEMID">
