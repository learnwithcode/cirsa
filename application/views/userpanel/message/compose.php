              ...
              <div class="panel panel-info news-wrap">
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-12">
						<?php get_message(); ?>
                      <form action="<?php echo  generateMemberForm("message","compose",array("")); ?>" id="form-valid" name="form-valid" method="post">
					  	 <div class="form-group">
                          <label for="transaction_password">To:</label>
                          <select name="message_to" id="message_to" class="form-control validate[required]">
						  		<option value="ADMIN">Admin</option>
						  </select>
                          <div class="clear">&nbsp;</div>
                        </div>
                        <div class="form-group">
                          <label for="transaction_password">Subject:</label>
                          <input type="text" name="subject" id="subject" placeholder="" value="" class="form-control validate[required]"/>
                          <div class="clear">&nbsp;</div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="submit" name="submitMessage" value="Send" class="btn btn-primary btn-submit" id="submitMessage"/>
                          &nbsp;&nbsp;
