...
$sel_query = $this->db->query("SELECT date_from,subcription_id FROM `tbl_subscription` WHERE member_id='$member_id'");
		$fetchRow = $sel_query->row_array();
		
		$datefrom = $fetchRow['date_from'];
		$sub_id = $fetchRow['subcription_id'];
...
$saturday = $startDate->format('Y-m-d');$i=10;
...
?>
						...
						<span class="line-height-1 bigger-170">Lucky Dips- <?php echo $i;?> </span>
						
						<br />
						<span class="line-height-1 smaller-90"><?php echo $saturday;?>  </span>												</span>
						
<?php 
$saturday = InsertDate(AddToDate($saturday,"+1 Week"));

}} else{ */?>
<div style="
    width: 50%;
    margin-left: 25%;">
				<img src="<?php echo BASE_PATH;?>assets/images/reward.gif" style="    width: 100%;
    height: auto;
    margin-top: 50px;"/>
...
<!-- popup of member congratulation dates-->
<style>
...
<div class="modal fade" id="memberModal1" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content amanwidthimg1">
           
                <button type="button" class=" close closeaman" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                </button>
                
            <span class="congo">   <img  src="<?php echo BASE_PATH;?>assets/images/popup/Congratulation.gif"/></span>
            
           <span > <img  src="<?php echo BASE_PATH;?>assets/images/popup/pawan.jpg" /></span>
            
            <h2 style="text-align:center;">  Again Bangkok Achiver</h2>
...
<div class="modal fade" id="memberModal" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content amanwidthimg">
           
                <button type="button" class="close closeaman" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                </button>
                
             <img src="<?php echo BASE_PATH;?>assets/images/independence/2.jpg"/>
