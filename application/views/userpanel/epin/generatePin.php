    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Generate Epin From Your Wallet 	</h4>
            ...
            <div class="card-content collapse show">
                ...
                <div class="card-text">
				 Available E-wallet: Rs. 	<code> <?php echo $LDGR['net_balance']; ?> /- </code>   
						
						
						</div> 

   <hr>		
		     <form action="<?php  echo  generateMemberForm("epin","generatePin"); ?>" id="sample-form" enctype="multipart/form-data" class="form-horizontal" name="form-valid" autocomplete="off" method="post">
		...
		<div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Wallet Type :</label>
									<div class="col-md-9">
		...
		<div class="form-group row">
		 ...
		 <div class="form-group row">
									...
									<div class="col-md-9">
	             <input class="form-control" name="no_pin" id="" type="number" placeholder="Epin Quantity" required>
	                            	</div>
		                        </div>
<div class="form-group row">
