...
$QR_PAGES= "SELECT tpd.*, tm.user_id, tm.first_name, tm.last_name, tpy.pin_name, 
			SUM(tpd.pin_price+tpm.pin_activation) AS net_pin_price,	used.first_name AS use_first_name,
			...
			LEFT JOIN ".prefix."tbl_pintype AS tpy ON tpd.type_id=tpy.type_id WHERE tpd.pin_sts='Y' 
			AND tpd.pin_id>0 AND tpd.use_member_id>0 AND tpd.member_id='".$member_id."' $StrWhr GROUP BY tpd.pin_id
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">My Used Epin</h4>
            ...
            <div class="card-content collapse show">
                ...
                <div class="table-responsive">
                    ...
                    <tr>
                      <td colspan="8" align="center" class=" text-danger"><i class="ace-icon fa fa-times bigger-110 red"></i> &nbsp; No record found</td>
                    </tr>
                    <?php } ?>
                      </tbody>
                    </table>
