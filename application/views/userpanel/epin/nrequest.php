...
<div class="widget-box">
	...
	<!--	<div class="widget-toolbar">
		...
		<form id="form-search" name="form-search" method="post" action="<?php  echo  generateMemberForm("epin","nrequest"); ?>" enctype="multipart/form-data" class="form-horizontal">
	 ...
	 <input type="radio" name="wallet_type" class="validate[required]" id="wallet_type" value="1" onclick="userfeilds();" checked="true"/>
	&nbsp;&nbsp;<label for="wallet_type">Generate From Wallet</label>
	
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="wallet_type" class="validate[required]" onclick="adminfeilds();"  id="wallet_type1" value="0" />
