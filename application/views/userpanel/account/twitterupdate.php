                            ...
                            <div class="col-md-12"> 
                              <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
								  ...
								  <div class="row">
								  	<div class="col-md-2">
                                      <label class=""> Share on twitter  : </label>
                                    </div>
									<div class="col-md-1">
									<a onClick="window.open('http://twitter.com/home?status=<?php echo WEBSITE." business plans";?> + <?php echo BASE_PATH.$ROW['user_name'];  ?>', 'sharer', 'toolbar=0,status=0,width=548,height=325');" target="_parent" href="javascript: void(0)"><img src="<?php echo BASE_PATH; ?>theme/images/share_twitter.png" style="width:32px; 32px;"></a>
									</div>
