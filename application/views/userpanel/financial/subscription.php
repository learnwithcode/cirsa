                              ...
                              <div class="col-sm-12">
								...
								?>
                                    <tr>
                                      ...
                                      <td><i class="fa fa-dollar"></i> <?php echo number_format($AR_DT['total_amt']); ?></td>
                                      <td><?php echo number_format($AR_DT['no_day']); ?></td>
                                      <td><i class="fa fa-dollar"></i> <?php echo number_format($AR_DT['daily_return']); ?> % </td>
                                      <td> <i class="fa fa-dollar"></i> <?php echo number_format($AR_DT['total_return']); ?></td>
                                    ...
                                    <tr>
                                      <td colspan="9" class="text-danger">No subscription found </td>
                                    </tr>
                                    <?php } ?>
                                  </tbody>
                                </table>
