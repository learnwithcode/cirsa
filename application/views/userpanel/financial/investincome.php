<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	$QR_PAGES="SELECT tmi.*, tm.user_id FROM ".prefix."tbl_mem_invest AS tmi 
                    ...
                    <div class="content-box">
                      <div class="box-body">
                        <div class="box-wrap clear">
                          <h2>Re-Investment Account</h2>
                          <br>
                          <div class="actions">
						  	<div class="row">
							 <div class="col-md-4">
                           <form id="form-search" name="form-search" method="get" action="<?php echo generateMemberForm("financial","investincome",""); ?>">
                          <b>Date from </b>
						  ...
						  <a href="<?php  echo generateSeoUrlMember("financial","investincome",array()); ?>" class="btn btn-sm btn-default m-t-n-xs" value=" Reset ">Reset</a>
                        </form>
							  </div>
							</div>
                          </div>
                              ...
                              <div class="col-sm-12">
								...
								?>
                                    <tr class="odd" role="row">
                                      ...
                                      <td class="sorting_1"><?php echo $AR_DT['trns_amount']; ?></td>
