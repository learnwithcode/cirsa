<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	$QR_PAGES="SELECT twt.* FROM ".prefix."tbl_ewallet_trns AS twt 
      ...
      <div class="row">
        <div class="col-mod-12">
          <ul class="breadcrumb">
            ...
            <li class="active">Fund Detail</li>
          </ul>
        </div>
      </div>
                            ...
                            <div class="top-menu-nav">
                                ...
                                <div class="sub-menus">
                                    <ul>
                                            ...
                                            <li><a class="current"  href="<?php  echo generateSeoUrlMember("financial","wallet",array()); ?>">Fund Detail</a></li>
                                    </ul>
                                </div>
                                <div class="clear"></div>
                            </div>
