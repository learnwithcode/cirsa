<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
 ...
 if($rewardid>0){ 	
 $QR_PAGES="SELECT * FROM  ".prefix."tbl_cmsn_reward  WHERE reward_id='$rewardid'  and member_id=$member_id";
     ...
     <div class="container">
			...
			// PrintR($status);
              ...
              <td><?php echo $AR_DT['reward_name']; ?></td>
                ...
                <td><?php echo CURRENCY; ?> <?php echo $AR_DT['amount']; ?></td>
				...
				<?php }?>
                 ...
                 <td data-title="Report"><a href="<?php echo generateSeoUrlMember("report","rank_rewards",""); ?>/<?php echo $AR_DT['reward_id']; ?>">View</a></td>
