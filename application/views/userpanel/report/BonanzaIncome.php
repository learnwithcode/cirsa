<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	$QR_PAGES="SELECT * FROM `tbl_Bonanza` ";
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Bonanza Income Report	</h4>
						 ...
						 <th> Time Limit</th>
                          ...
                          <th>Status</th>
							...
							//	echo "<pre>";print_r($PageVal['ResultSet']);die;
                                ...
                                <tr class="odd" <?php if($getstatus > 0 ) { ?>style="background: #4728f1!important;" <?php } ?> role="row">
                                     <td class=""><?php echo $Ctrl;$Ctrl++; ?></td>
                              <td><span class="label label-lg label-pink arrowed-right"><?php echo $AR_DT['bonanza_name'] ; ?></span></td> 
									 <td><?php echo $AR_DT['matching_pv']; ?></td>
									  <td><?php  echo $AR_DT['bonanza_amt'];?> /-  </td>
									    <td><?php  echo $AR_DT['num_day'] .' ('.$AR_DT['type'].')';?>   </td>
