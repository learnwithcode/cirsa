<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	$QR_PAGES="SELECT tcd.*, tm.user_id FROM ".prefix."tbl_cmsn_cashback AS tcd 
			  LEFT JOIN tbl_members AS tm ON tcd.member_id = tm.member_id
				  WHERE tcd.member_id='".$member_id."' $StrWhr ORDER BY tcd.cashback_id DESC";
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Cashback Income Report</h4>
                ...
                <div class="table-responsive">
                    ...
                    <thead>
                                  ...
                                  <tbody>
									...
									$Ctrl= $PageVal['RecordStart']+1; $PageVal['ResultSet']='';
								...
								?>
									...
									?>
                                    <tr class="odd" role="row">
                                      <td colspan="3" align="center" class="">No transaction found</td>
                                    </tr>
                                    <?php 
									}
								 ?>
