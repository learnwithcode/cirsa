    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Royalty Income Report	</h4>
                      ...
                      <tr>
                          ...
                          <th>Status</th>
							...
							//	echo "<pre>";print_r($PageVal['ResultSet']);die;
                              ...
                              <td><span class="label label-lg label-pink arrowed-right"><?php echo $AR_DT['reward_name'] ; ?></span></td> 
									 
									  <td><?php  echo $AR_DT['reward_amt'];?> /-  </td>
