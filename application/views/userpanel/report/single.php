<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	$QR_PAGES= "SELECT tcd.*,tmf.user_name AS to_user_name, tmf.first_name AS to_name
				FROM ".prefix."tbl_cmsn_single AS tcd 
                  ...
                  <tbody>
                    ...
                    <tr class="odd" role="row">
                      ...
                      <td data-title="name"><?php echo strtoupper($AR_DT['to_name']); ?></td>
                       <td data-title="Level"><?php echo $AR_DT['leg_id']; ?></td>
