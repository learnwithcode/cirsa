...
?>
	...
	<div class="main-content">
 	...
 	<h4 class="card-title">Magic-wallet History	</h4>	
 Available USD : $ <?php echo number_format($LDGR['net_balance'],2); ?>
   ...
   <tbody>  <?php 
								...
								?>
                                    <tr class="odd" role="row">
                                      ...
                                      <td class="sorting_1"><?php echo ( $AR_DT['trns_type'] =='Cr')?'Credit':'Debit'; ?></td>
