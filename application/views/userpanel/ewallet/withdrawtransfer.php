	...
	<div class="main-content">
        <section class="section">
          <div class="section-body">
            ...
            <form action="<?php echo BASE_PATH;?>member/ewallet/withdrawtransfer" method="post">
...
<div class="form-group">
												<label for="cryptoname">Select Crypto</label>
												<select class="form-control" name="cryptoname" id="cryptoname">
     ...
     <input class="form-control" required="" id="draw_amount" name="draw_amount" placeholder="Please enter Transfer USD" data-toggle="tooltip" title="Please enter Transfer USD" type="number">
     </div>
           <div class="form-group">
